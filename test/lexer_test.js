...
describe('Lexer', function () {
    ...
    describe('#tokenizer()', function () {
        ...
        it('should return tokens when a comments and log are given in the same line respectively', function () {
        ...
        it('should return tokens when a comments are given in multiple lines', function () {
            let tokens = new Lexer('# Test 1\n# Test 2');
